...
clean_file = open('stops_agglom.csv', mode='w')
csv_writer = csv.writer(clean_file, delimiter=',')
csv_writer.writerow(['stop_id', 'stop_desc', 'lat', 'lon'])
...
with open('../data/bronx/stops.txt', newline='', mode='r') as bronx:
...
with open('../data/staten/stops.txt', newline='', mode='r') as staten:
...
with open('../data/brooklyn/stops.txt', newline='', mode='r') as brooklyn:
...
with open('../data/manhattan/stops.txt', newline='', mode='r') as manhattan:
...
with open('../data/queens/stops.txt', newline='', mode='r') as queens:
